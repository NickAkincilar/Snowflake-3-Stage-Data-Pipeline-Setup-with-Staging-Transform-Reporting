...
**It will create all necessary resources including Warehouses, roles, users, databases, schemas, usage monitores & security using best practices automatically to give you a quick head start. Below is the diagram of what will be setup and the security for each role.**
